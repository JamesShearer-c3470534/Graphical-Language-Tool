...
namespace GraphicalLanguageTool
{
    ...
    {
        /// <summary>
        /// <see cref="SqlConnection"/> used for the <see cref="GraphicalLanguageTool.NewBugForm"/> form.
        /// </summary>
        SqlConnection newBugConnection;

        /// <summary>
        ///  Entry point for the <see cref="GraphicalLanguageTool.NewBugForm"/> form.
        /// </summary>
        public NewBugForm()
        {
            InitializeComponent();
            txtAuthorNew.Text = GraphicalLanguageTool.Login.sessionUsername;
        }
        ...
        private void ButtonNewBug_Click(object sender, EventArgs e)
        {
            if (CheckInputs())
            {
                ...
                InsertVerRecord("0", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff"), txtCodeNew.Text, GraphicalLanguageTool.Login.sessionUsername, bugId, "0", verCommandString);
