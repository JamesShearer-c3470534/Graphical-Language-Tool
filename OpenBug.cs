...
namespace GraphicalLanguageTool
{
    ...
    {
        /// <summary>
        /// <see cref="SqlConnection"/> used for the <see cref="GraphicalLanguageTool.OpenBug"/> form.
        /// </summary>
        ...
        /// <summary>
        ///  Entry point for the <see cref="GraphicalLanguageTool.OpenBug"/> form.
        /// </summary>
        public OpenBug()
        {
            InitializeComponent();
        ...
        private void PopulateOpenList()
        {
            ...
            switch (caseSwitch)
            {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    selcmd = "SELECT BugId, Application, Username, Language, Fixed FROM BugTable WHERE Username = '" + GraphicalLanguageTool.Login.sessionUsername + "' AND Language = '" + comboBoxLanguage.Text + "'";
                    break;
                case 6:
                    selcmd = "SELECT BugId, Application, Username, Language, Fixed FROM BugTable WHERE Username = '" + GraphicalLanguageTool.Login.sessionUsername + "'";
                    break;
                case 7:
                    selcmd = "SELECT BugId, Application, Username, Language, Fixed FROM BugTable WHERE Fixed = 0 AND Username = '" + GraphicalLanguageTool.Login.sessionUsername +"' AND Language = '" +comboBoxLanguage.Text + "'";
                    break;
                case 8:
                    selcmd = "SELECT BugId, Application, Username, Language, Fixed FROM BugTable WHERE Fixed = 0 AND Username = '" + GraphicalLanguageTool.Login.sessionUsername + "'";
                    break;
            }
